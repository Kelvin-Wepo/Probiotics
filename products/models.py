...
class Product(models.Model):
    ...
    price           = models.DecimalField(decimal_places=2, max_digits=20, default=2000.00)
    image           = models.ImageField(upload_to='product_images/', null=True, blank=True)
    featured        = models.BooleanField(default=False)
    active          = models.BooleanField(default=True)
    category        = models.CharField(max_length=150, choices=CATEGORY , default= Men)
    manufacturer    = models.CharField(max_length=150, choices=MANUFACTURER, default= Nestle )
